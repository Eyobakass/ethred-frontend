      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {agencies.map((agency) => (
            <div
              key={agency.id}
              className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 hover:border-gold-500/40 transition group space-y-4 shadow-xl"
            >
              {/* Agency avatar */}
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-tr from-neutral-800 to-neutral-700 border border-neutral-700 flex items-center justify-center text-2xl flex-shrink-0">
                  {agency.logo_url ? (
                ...
                <div className="min-w-0">
                  <h2 className="text-sm font-bold text-white group-hover:text-gold-400 transition truncate">
                    {agency.name}
                  </h2>
                  {agency.is_verified && (
              ...
              <Link
                ...
                className="block text-center py-2.5 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-white text-xs font-semibold transition border border-neutral-700"
              >
