    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-neutral-200 dark:border-neutral-800 pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-white mt-0.5">{lang === 'am' ? 'የኦዲት መዝገቦች' : 'Audit Logs'}</h1>
        </div>
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg overflow-hidden shadow-sm">
        {isLoading ? (
          ...
          <div className="py-16 flex flex-col items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-neutral-300 dark:text-neutral-700 mb-3"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><path d="m9 16 2 2 4-4"/></svg>
            <p className="text-sm font-medium text-neutral-500 dark:text-neutral-400">{lang === 'am' ? 'ምንም የኦዲት መዝገብ አልተገኘም።' : 'No audit log entries found.'}</p>
          </div>
        ) : (
          <>
                    ...
                    <React.Fragment key={log.id}>
                      <tr className="hover:bg-neutral-50 dark:hover:bg-neutral-800/40 transition">
                        ...
                        <td className="px-4 py-3">
                          <span className={`px-2 py-0.5 rounded font-semibold text-[11px] ${actionColor(log.action)}`}>
                            {log.action}
                          </span>
                        </td>
                        ...
                        <td className="px-4 py-3 text-right">
                          {(log.new_values || log.old_values) && (
                            <button
                              ...
                              {expandedId === log.id ? (
                                <><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m18 15-6-6-6 6"/></svg> Hide</>
                              ) : (
                                <><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6"/></svg> Details</>
                              )}
                            </button>
                          )}
                        </td>
                        ...
                        <tr className="bg-neutral-50 dark:bg-neutral-950">
                          <td colSpan={6} className="px-6 py-4">
                            <div className="space-y-3">
                              {log.old_values && (
                                <div>
                                  <p className="text-[10px] font-semibold text-neutral-500 uppercase mb-1">Old Values</p>
                                  <pre className="text-[11px] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-md p-3 overflow-x-auto text-neutral-700 dark:text-neutral-300">
                              ...
                              {log.new_values && (
                                <div>
                                  <p className="text-[10px] font-semibold text-neutral-500 uppercase mb-1">New Values</p>
                                  <pre className="text-[11px] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-md p-3 overflow-x-auto text-neutral-700 dark:text-neutral-300">
            ...
            {totalPages > 1 && (
              <div className="px-5 py-4 border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-between text-xs">
                <span className="text-neutral-500 font-medium">Page {page} of {totalPages} · {total} entries</span>
