...
- Name: buyer.spec.ts >> Buyer Flow >> should view property details and track recently viewed
- Location: tests\e2e\buyer.spec.ts:16:7
...
=========================== logs ===========================
waiting for navigation to "**/en/properties?category=APARTMENT" until "load"
  navigated to "http://localhost:3000/en/properties"
============================================================
```
  ...
  - contentinfo [ref=e216]:
    - generic [ref=e217]:
      ...
      - generic [ref=e224]:
        ...
        - list [ref=e226]:
          - listitem [ref=e227]:
            - link "Apartments for Sale" [active] [ref=e228] [cursor=pointer]:
